        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="auth-content">
                    <div class="panel-heading">Пожайлуста зарегистрируйтесь !</div>
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" class="auth-checkbox"
                                           name="credential" {{ old('remember') ? 'checked' : '' }}>
                                   Хотите быть анминистратором ?
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary btn-primary-reg">
                                    Зарегистрироваться
                                </button>
                            </div>
                        </div>
